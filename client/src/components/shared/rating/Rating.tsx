...
const Rating = () => {
  return (
    <RatingStyled role="img" aria-labelledby="starRating-oe600nhsj6o" viewBox="0 0 251 46" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="tp-star">
          <path className="tp-star__canvas" fill="#00b57a" d="M51.24816 46.330002h46.375587V0H51.248161z"></path>
          <path className="tp-star__canvas--half" fill="#00b57a" d="M51.24816 46.330002h23.187793V0H51.248161z"></path>
      ...
      <g className="tp-star">
          <path className="tp-star__canvas" fill="#00b57a" d="M102.532209 46.330002h46.375586V0h-46.375586z"></path>
          <path className="tp-star__canvas--half" fill="#00b57a" d="M102.532209 46.330002h23.187793V0h-23.187793z"></path>
      ...
      <g className="tp-star">
          <path className="tp-star__canvas" fill="#00b57a" d="M153.815458 46.330002h46.375586V0h-46.375586z"></path>
          <path className="tp-star__canvas--half" fill="#00b57a" d="M153.815458 46.330002h23.187793V0h-23.187793z"></path>
      ...
      <g className="tp-star">
          ...
          <path className="tp-star__canvas--half" fill="#00b57a" d="M205.064416 46.330002h23.187793V0h-23.187793z"></path>
